const koKR = {
  ...
  diaryEditor: {
    ...
    searchOpen: '일기에서 검색',
    searchPlaceholder: '이 일기에서 검색...',
    searchNoResult: '결과 없음',
    searchPrevious: '이전 일치',
    searchNext: '다음 일치',
    searchClose: '검색 닫기',
  ...
  settings: {
    ...
    sync: {
      card: '연결된 기기',
      title: 'LAN 동기화',
      subtitle: '같은 네트워크의 휴대폰과 일기를 안전하게 동기화합니다',
      description: '클라우드 없이 일기, 보관함, 이미지를 종단 간 암호화로 동기화',
      open: '동기화 열기',
      back: '설정으로 돌아가기',
      enable: 'LAN 동기화 사용',
      enableDescription: 'ShadowDiary 실행 중 페어링된 휴대폰이 이 컴퓨터를 찾을 수 있습니다',
      secure:
        '본문, 메타데이터, 이미지는 AES-256-GCM으로 암호화되며 페어링된 기기만 접근할 수 있습니다.',
      running: '실행 중',
      stopped: '중지됨',
      statusDescription: '활성화하면 같은 Wi-Fi의 휴대폰 앱이 이 컴퓨터를 자동으로 찾습니다.',
      lastSync: '마지막 동기화: {time}',
      status: {
        disabled: '동기화 서비스 일시 중지',
        discovering: '휴대폰을 기다리는 중',
        pairing: '인증 코드 준비됨',
        connecting: '기기 확인 중',
        syncing: '기록 동기화 중',
        conflicts: '충돌 확인 필요',
      ...
      pairNew: '새 휴대폰 페어링',
      pairDescription: '일회용 코드를 만든 후 휴대폰에서 이 컴퓨터를 선택하세요',
      createCode: '코드 만들기',
      pairingCode: '일회용 인증 코드',
      expires: '{seconds}초 후 만료',
      pairHint: '2분 동안 유효한 코드가 여기에 표시됩니다',
      pairedDevices: '페어링된 기기',
      pairedDescription: '다시 발견되면 자동으로 동기화할 수 있습니다',
      noPairedDevices: '아직 페어링된 휴대폰이 없습니다',
      neverSynced: '첫 동기화가 아직 완료되지 않았습니다',
      unpair: '페어링 해제',
      unpairTitle: '이 기기의 페어링을 해제할까요?',
      unpairDescription: '“{name}”의 페어링을 해제하면 다시 연결할 때 새 인증 코드가 필요합니다.',
      conflicts: '대기 중인 충돌',
      conflictsDescription: '{count}개 항목이 양쪽 기기에서 수정되었습니다',
      diary: '일기 충돌',
      archive: '보관함 충돌',
      resolveConflict: '유지할 버전 선택',
      desktopVersion: '이 컴퓨터',
      phoneVersion: '휴대폰',
      keepDesktop: '컴퓨터 버전 유지',
      keepPhone: '휴대폰 버전 유지',
      keepBoth: '둘 다 유지',
      deleted: '삭제됨',
      confirmResolutionTitle: '충돌 해결 결과를 저장할까요?',
      confirmResolutionDescription:
        '“{choice}”을(를) 적용합니다. 저장하면 이 충돌은 대기 목록에서 제거되며 여기에서 되돌릴 수 없습니다.',
      confirmSave: '저장 확인',
      saveConfirmationHint: '버전을 선택한 뒤 확인해야 저장됩니다',
      diff: {
        changed: '수정됨',
        reviewLabel: '컴퓨터와 휴대폰 버전의 Git 차이',
        title: '제목',
        date: '날짜',
        mood: '기분',
        weather: '날씨',
      ...
      errorTitle: 'LAN 동기화 오류',
      errors: {
        authentication: '기기 인증에 실패했습니다. 페어링을 해제한 후 다시 시도하세요.',
        pairing: '인증 코드가 잘못되었거나 만료되었거나 시도 횟수를 초과했습니다.',
        asset: '이미지 무결성 확인에 실패하여 이번 동기화를 적용하지 않았습니다.',
        port: 'LAN 포트를 열 수 없습니다. 방화벽 설정을 확인하세요.',
        connection: '연결이 중단되었습니다. 두 기기가 같은 네트워크에 있는지 확인하세요.'
      }
    },
    ai: {
      title: 'AI Settings',
